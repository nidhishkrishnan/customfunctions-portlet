...
/**
 * Provides the local service interface for Colors. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author user
 * @see ColorsLocalServiceUtil
...
public interface ColorsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ColorsLocalServiceUtil} to access the colors local service. Add custom service methods to {@link com.colors.themes.service.impl.ColorsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
